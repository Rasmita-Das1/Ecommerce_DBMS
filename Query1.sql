...
Select c.cus_gender, count(c.cus_gender) as "Number of Customers"
from customer as c,`order` as O where o.cus_id=c.cus_id and o.ord_amount>=3000 group by cus_gender;
